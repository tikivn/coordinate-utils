...
public class SingleCandidateTest {
	...
	public void initZooKeeper() {
		zooKeeper = ZooKeeperHelper.initZooKeeper(DEFAULT_ZOOKEEPER, 1000, 30000);
	}
	...
	@Test
	public void test_Update_Data_Of_Leader_From_Current_Leader() throws Exception {
	...
	private void changeData(ZooKeeperLeaderElection leaderElection, BObject newCandidateData)
